...
<html>
    ...
    <div class="container after-cls pt30 pb30">
        <div class="article-left">
            ...
            <div class="article-loadmore" id="article_loadnone">很抱歉，没有搜索到“<?php if(!empty($keyword)){ echo $keyword; } ?>”相关的小说</div>
    ...
    $(function(){
        ...
        $(window).on("scroll",function(){
            ...
            $.ajax({
                type:"post",
                url:"<?php echo base_url() ?>spore/Index_controller/get_articleSearchAjax_tpl",
                async:true,
                data:{
                    keyword:$("#keyword").val(),
                    page: current_page+1
